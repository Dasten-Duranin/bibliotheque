...
use BookcaseBundle\Entity\Categories;
use BookcaseBundle\Form\CategoriesType;
...
class CategoriesController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('BookcaseBundle:Categories')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('BookcaseBundle\Form\CategoriesType', $category);
    ...
    {
        $deleteForm = $this->createDeleteForm($category);
        $editForm = $this->createForm('BookcaseBundle\Form\CategoriesType', $category);
